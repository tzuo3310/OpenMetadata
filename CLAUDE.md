...
- **Frontend**: React + TypeScript, built with **Vite** (not Webpack) and Yarn; component library is `openmetadata-ui-core-components` (Tailwind CSS v4 with `tw:` prefix, react-aria-components foundation)
